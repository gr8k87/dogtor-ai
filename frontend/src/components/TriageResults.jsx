      ...
      <div className="max-w-md mx-auto space-y-6">
          ...
          {triageResults.meta?.error && (
            <div className="mt-4 bg-orange-50 border border-orange-200 rounded-xl p-3">
              <div className="flex items-center">
                <svg className="w-4 h-4 text-orange-600 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <svg className="w-4 h-4 inline mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
