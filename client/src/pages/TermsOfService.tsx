        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Dogtor AI is an AI-powered app that provides preliminary
                guidance about pet health concerns. We analyze photos and
                symptoms to offer suggestions for further care.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="p-6 bg-red-50 border-l-4 border-red-400 mb-6">
                ...
                <p className="text-red-700">
                  ...
                  substitute for professional veterinary diagnosis, treatment,
                  or advice. Always consult with a licensed veterinarian for
                  actual medical care of your pet.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="p-4 bg-yellow-50 border-l-4 border-yellow-400 mb-4">
                <p className="text-yellow-800">
                  <strong>In case of pet emergency:</strong> Do not use this
                  app. Contact your local emergency veterinary clinic
                  immediately.
                </p>
              </div>
            </section>
